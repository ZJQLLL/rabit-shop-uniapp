...
import {getHomeBannerAPI, type GetHomeBannerResult} from '@/services/home'
...
//左侧一级菜单分类
const categoryList = ref<GetCategoryTopResult[]>([])
  ...
  <view class="viewport" v-if="isFinish">
    ...
    <view class="categories">
      ...
      <scroll-view class="secondary" scroll-y>
        ...
        <!-- 内容区域 -->
        <view class="panel" v-for="item in currentSubCategoryList" :key="item.id">
          <view class="title">
            <text class="name">{{ item.name }}</text>
