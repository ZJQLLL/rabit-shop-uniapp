...
export interface GetGoodsDetailParams {
    /**
     * 商品id
     */
    id: string;
}
export interface GetGoodsDetailResult {
    /**
     * 品牌信息
     */
    brand: Brand;
...
export const getGoodsDetailAPI = (data:GetGoodsDetailParams)=>{
    return http<GetGoodsDetailResult>({
        method:'GET',
        url:'/goods',
        data,
    })
